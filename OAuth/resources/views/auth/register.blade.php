        ...
        <div class="col-md-8 col-lg-6">
            <div class="auth-card">
                <div class="auth-card-header">
                    ...
                    <p class="auth-card-subtitle">Join our community today</p>
                </div>

                <div class="auth-card-body">
                    <!-- Google Sign-In Button -->
                    <div class="social-auth">
                        <a href="{{ route('login.google') }}" class="google-auth-btn">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group terms-agreement">
                            ...
                            <label for="terms">
                                I agree to the <a href="{{ route('home') }}" target="_blank">Terms of Service</a> and <a href="{{ route('home') }}" target="_blank">Privacy Policy</a>
                            </label>
                            @error('terms')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
